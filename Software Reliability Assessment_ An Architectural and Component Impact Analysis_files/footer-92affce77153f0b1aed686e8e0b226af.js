...
$(document).ready(function ($) {
  ...
  $(window).scroll(function () {
    ...
    if (scrollTop > 500) {
      $('#cd_top').css('visibility', 'visible');
      $('#feed_back').css('visibility', 'visible');
    } else {
      $('#cd_top').css('visibility', 'hidden');
      $('#feed_back').css('visibility', 'hidden');
    }
  });
  var clicking = false;
  $('#cd_top').on('click', function (event) {
    var behavior = $('body,html').css('scroll-behavior');
    // 设置页面的滚动行为默认
    ...
    if (!clicking) {
      ...
      $('#cd_top').css('visibility', 'hidden');
      $('#feed_back').css('visibility', 'hidden');
      $('body,html').animate({ scrollTop: 0 }, scroll_top_duration, function () {
        $(this).css('scroll-behavior', behavior);
      });
    }
  });
});
...
function showYxAlert(type, message, time) {
  ...
  switch (type) {
    case 'success':
      alertDom = $(
        '<div class="alert alert-success alert-dismissible fade in yx-alert" role="alert">\n' +
    ...
    case 'info':
      alertDom = $(
        '<div class="alert alert-info alert-dismissible yx-alert" role="alert">\n' +
          '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n' +
          '  <strong>Info!</strong> ' +
          message +
          '</div>'
    ...
    case 'warning':
      alertDom = $(
        '<div class="alert alert-warning alert-dismissible yx-alert" role="alert">\n' +
          '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n' +
    ...
    case 'danger':
      alertDom = $(
        '<div class="alert alert-danger alert-dismissible yx-alert" role="alert">\n' +
          '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n' +
    ...
    default:
      alertDom = $(
        '<div class="alert alert-success alert-dismissible yx-alert" role="alert">\n' +
          '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n' +
          '  <strong>Info!</strong> ' +
          message +
          '</div>'
